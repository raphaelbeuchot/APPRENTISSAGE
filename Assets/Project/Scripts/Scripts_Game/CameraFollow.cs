...
public class CameraFollow : MonoBehaviour
{
    ...
    private void UpdateLockedCamera()
    {
        ...
        float sourisX = Input.GetAxis("Mouse X") * sensibiliteSouris * lockMouseInfluence * Time.deltaTime;
        float sourisY = Input.GetAxis("Mouse Y") * sensibiliteSouris * lockMouseInfluence * Time.deltaTime;
