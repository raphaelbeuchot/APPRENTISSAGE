...
- **⚠️ Commit a revert en cas de regression solo** : `e7ea6292` ("sentinelle multi : stun et feedback de detection scopes par joueur") — contient les deux fixes ci-dessous. `git revert e7ea6292` annule proprement sans toucher au reste.
